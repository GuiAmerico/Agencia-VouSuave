...
const TermosDeUso = () => {
    document.title =  "Agência VouSuave | Termos de Uso"

    return (
        <main>
            <article className="container mt-5">
                <h1>Termos de Uso</h1>
                <p>Este Portal é controlado e operado pela própria VouSuave, agência de viagens brasileira</p>
                <p>POR FAVOR, LEIA ATENTAMENTE OS TERMOS E CONDIÇÕES AQUI APRESENTADOS E OS DEMAIS AVISOS QUE POSSAM APARECER EM OUTRAS PÁGINAS DE NOSSO SITE. AO ACESSÁ-LO,
                    VOCÊ CONCORDA COM OS PRESENTES TERMOS E CONDIÇÕES DE USO. CASO VOCÊ NÃO CONCORDE, NÃO ACESSE ESTE SITE OU QUAISQUER DE SUAS PÁGINAS</p>
                <h2 className="h4">Informação</h2>
                <p>TERMOS DE SERVIÇO
                    ...
                    Você concorda em indenizar, defender e isentar VouSuave e nossa matriz, subsidiárias, afiliadas, parceiros, executivos, diretores, agentes, contratados, licenciantes, prestadores de serviços, subcontratados, fornecedores, estagiários e funcionários, de qualquer reivindicação ou demanda, incluindo honorários advocatícios razoáveis, feitos por terceiros, devido a ou decorrente de sua violação destes Termos de serviço ou dos documentos que incorporam por referência, ou sua violação de qualquer lei ou dos direitos de terceiros.
                    ...
                    Estes Termos de serviço e quaisquer contratos separados nos quais fornecemos a você os Serviços serão regidos e interpretados de acordo com as leis de Centro, Rio de Janeiro, RJ, Brasil.
                    ...
                    Perguntas sobre os Termos de serviço devem ser enviadas para nós em VouSuave@recode.org.br</p>
            </article>
        </main>
    )
}
